        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Data Sopir</a></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Sopir</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('updatesopir', $supir->id_supir) }}" method="POST">
                                    @csrf
                                    @method('patch')
                                    ...
                                    <div class="input-group mb-3 ">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nama Sopir"
                                            name="nama_supir" value="{{ $supir->nama_supir }}">
                                    </div>
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <textarea class="form-control" style="height: 94px;" name="alamat">{{ $supir->alamat }}</textarea>
                                    </div>
