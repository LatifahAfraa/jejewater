...
@section('title', 'PT. Indomex Dwijaya Lestari - Edit Data Type Ban')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Data Type Ban</a></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Type Ban</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('updatetype', $type->id_type) }}" method="POST">
                                    @csrf
                                    @method('patch')
