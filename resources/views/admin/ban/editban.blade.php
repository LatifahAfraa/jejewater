...
@section('title', 'PT. Indomex Dwijaya Lestari - Edit Data Ban')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Data Ban</a></li>
                </ol>
            </div>
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Ban</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('updateban', $ban->id_ban) }}" method="POST">
                                    @csrf
                                    @method('patch')
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="nama_ban" class="form-control" value="{{ $ban->merk_ban_id }}">
                                            <option value="">Pilih</option>
                                            @foreach ($merk as $data)
                                                <option value="{{ $data->merk_ban_id }}">{{ $data->merk_ban_nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="id_type" class="form-control" value="{{ $ban->id_type }}">
                                            <option value="">Pilih</option>
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <select name="id_kondisi" class="form-control" value="{{ $ban->id_kondisi }}">
                                            <option value="">Pilih</option>
